...
public class Daughter extends Activity {
    ...
    {
    	 Intent in=new Intent(Daughter.this,MainActivity.class);
    	 startActivity(in);
    }
    
    public void edit_click(View view)
    {
    	 Intent in=new Intent(Daughter.this,ParentDaughterList.class);
    	 startActivity(in);
    }
    ...
    public void store_click(View view)
    {
        ...
        String sql="insert into DAUGHTER values('"+mobile+"')";
